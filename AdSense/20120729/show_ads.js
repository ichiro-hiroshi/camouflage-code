(function () {
    ...
    var z = g,
        la = function () {
            if (!z) {
                for (var a = window, b = a, c = 0; a != a.parent;) if (a = a.parent, c++, y(a)) b = a;
                else break;
                z = b
            }
            return z
    ...
    B.prototype.n = function (a, b) {
        0 == this.b && 0 == this.c.length && (!b || b == window) ? (this.b = 2, this.g(new ma(a, window))) : this.h(a, b)
    };
    ...
    var na = function (a) {
        ...
        return !!a && ("object" == typeof a || "function" == typeof a) && na(a) && v(a.nq) && v(a.nqa) && v(a.al) && v(a.rl)
    }, D = function () {
        if (A && na(A)) return A;
        var a = la(),
    ...
    var ra = /MSIE [2-7]|PlayStation|Gecko\/20090226/i,
        sa = /Android|Opera/,
        ta = function () {
            var a = E,
                b = F.google_ad_width,
    ...
    var wa = function () {}, J = function (a, b, c) {
        switch (typeof b) {
        case "string":
            xa(b, c);
            break;
        ...
        case "object":
            ...
            if (b instanceof Array) {
                var e = b.length;
                c.push("[");
                for (var d = "", h = 0; h < e; h++) c.push(d), J(a, b[h], c), d = ",";
                c.push("]");
                break
            }
            c.push("{");
            e = "";
            for (d in b) b.hasOwnProperty(d) && (h = b[d], "function" != typeof h && (c.push(e), xa(d, c), c.push(":"), J(a, h, c), e = ","));
            c.push("}");
            break;
        case "function":
            break;
    ...
    var M = function (a) {
        ...
        a.google_iframe_oncopy || (a.google_iframe_oncopy = {
            handlers: {},
            log: [],
            shouldLog: 0.01 > Math.random() ? f : i
        });
    ...
    var Ba = function () {
        var a = "script";
        return ["<", a, ' src="', va(u(""), "/pagead/js/r20120718/r20120410/show_ads_impl.js", ""), '"></', a, ">"].join("")
    }, Ca = function (a, b, c, e) {
        return function () {
            var d = i;
            e && D().al(3E4);
            try {
                if (y(a.document.getElementById(b).contentWindow)) {
                    var h = a.document.getElementById(b).contentWindow,
                        o = h.document;
                    if (!o.body || !o.body.firstChild) o.open(), h.google_async_iframe_close = f, o.write(c)
                } else {
                    ...
                    G.location.replace("javascript:" + W)
                }
                d = f
            } catch (nb) {
                G = la().google_jobrunner, oa(G) && G.rl()
            }
            d && (new M(a)).set(b, Ca(a, b, c, i))
        }
    }, Da = Math.floor(1E6 * Math.random()),
        Ea = function (a) {
            for (var a = a.data.split("\n"), b = {}, c = 0; c < a.length; c++) {
                var e = a[c].indexOf("="); - 1 != e && (b[a[c].substr(0, e)] = a[c].substr(e + 1))
            }
    ...
    if (La) {
        ...
        for (var F = window, _script$$inline_89 = "script", U, E = {
        ...
        Oa.write(ta());
        U = V;
        var Qa, Ra = F.google_adk_experiment,
            Sa;
        if ("control" == Ra) Sa = "control";
            ...
            if ("expt" == Ra) {
                ...
                if (s) {
                    var Y;
                    if (s) {
                        for (var Va = [], Wa = 0, Z = s; Z && 25 > Wa; Z = Z.parentNode, ++Wa) Va.push(Z.id || "");
                        Y = Va.join()
                    } else Y = "";
                    Y && Ua.push(Y)
                }
        ...
        var mb = (new Date).getTime(),
            ob = window.google_top_experiment,
            pb = ["<!doctype html><html><body><", _script$$inline_89, ">", ab, "google_show_ads_impl=true;google_unique_id=", F.google_unique_id, ';google_async_iframe_id="', U, '";google_start_time=', k, ";", ob ? 'google_top_experiment="' + ob + '";' : "", Qa ? 'google_adk_sa="' + Qa + '";' : "", "google_bpp=", mb > k ? mb - k : 1, ";</", _script$$inline_89, ">", Ba(), "</body></html>"].join("");
